...
public class ServiceLocator extends org.apache.axis.client.Service implements com.yuwang.pinju.core.order.manager.impl.LogisticsService.Service {

    public ServiceLocator(String serviceURL) {
    	this.ServiceSoap_address = serviceURL;
    }
    ...
    public com.yuwang.pinju.core.order.manager.impl.LogisticsService.ServiceSoapLogistics getServiceSoap() throws javax.xml.rpc.ServiceException {
    ...
    public com.yuwang.pinju.core.order.manager.impl.LogisticsService.ServiceSoapLogistics getServiceSoap(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.yuwang.pinju.core.order.manager.impl.LogisticsService.ServiceSoapStub _stub = new com.yuwang.pinju.core.order.manager.impl.LogisticsService.ServiceSoapStub(portAddress, this);
    ...
    private java.lang.String ServiceSoap12_address = "";
    ...
    public com.yuwang.pinju.core.order.manager.impl.LogisticsService.ServiceSoapLogistics getServiceSoap12() throws javax.xml.rpc.ServiceException {
       java.net.URL endpoint;
        try {
    ...
    public com.yuwang.pinju.core.order.manager.impl.LogisticsService.ServiceSoapLogistics getServiceSoap12(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.yuwang.pinju.core.order.manager.impl.LogisticsService.ServiceSoap12Stub _stub = new com.yuwang.pinju.core.order.manager.impl.LogisticsService.ServiceSoap12Stub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.yuwang.pinju.core.order.manager.impl.LogisticsService.ServiceSoapLogistics.class.isAssignableFrom(serviceEndpointInterface)) {
                com.yuwang.pinju.core.order.manager.impl.LogisticsService.ServiceSoapStub _stub = new com.yuwang.pinju.core.order.manager.impl.LogisticsService.ServiceSoapStub(new java.net.URL(ServiceSoap_address), this);
                _stub.setPortName(getServiceSoapWSDDServiceName());
                return _stub;
            }
            if (com.yuwang.pinju.core.order.manager.impl.LogisticsService.ServiceSoapLogistics.class.isAssignableFrom(serviceEndpointInterface)) {
                com.yuwang.pinju.core.order.manager.impl.LogisticsService.ServiceSoap12Stub _stub = new com.yuwang.pinju.core.order.manager.impl.LogisticsService.ServiceSoap12Stub(new java.net.URL(ServiceSoap12_address), this);
                _stub.setPortName(getServiceSoap12WSDDServiceName());
                return _stub;
            }
        }
