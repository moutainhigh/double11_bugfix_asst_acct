...
public class EmailValidator {
	 ...
	 */
	protected static boolean isValidIpAddress(Perl5Util ipAddressMatcher) {
		for (int i = 1; i <= 4; i++) {
	 ...
	 */
	protected static boolean isValidSymbolicDomain(String domain) {
	 ...
	 */
	protected static String stripComments(String emailStr) {
