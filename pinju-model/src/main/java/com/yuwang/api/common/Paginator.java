...
public class Paginator implements Serializable, Cloneable {
	...
	private int start; // 用与mysql数据库分页 Add By Qiuhongming@2011.07.13
	private String action = StringUtils.EMPTY; //分页的action名称 Add By ShiXing@2011.07.02
	...
	public void setAction(String action) {
		this.action = (action==null ? StringUtils.EMPTY : action);
	}
