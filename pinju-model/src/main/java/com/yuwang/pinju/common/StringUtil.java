...
public class StringUtil {
     ...
     * <p>Discription:[判断给定字符是否为汉字,true是,false不是]</p>;
     * @param c
     * @return true | false
     * @author:[石兴]
    ...
    /**
     * Created on 2011-7-29
     * <p>Discription:[获取中英文混输下的字符串长度,中文按2字节算]</p>
     * @param
     * @return
     * @author:[石兴]
     * @update:[日期YYYY-MM-DD] [更改人姓名]
    ...
    /**
     * <p>将密码隐去当中的字符，长度固定为 8 位。如果字符串长度大于 16 位不进行任何处理</p>
     *
     * @param password
     * @return
     *
     * @author gaobaowen
     * @since 2011-7-29 10:29:32
     */
    ...
    /**
     * <p>隐藏 Email 地址。仅保留 email 用户名的第一个字符和最后一个字符，后面加上 5 个星号（无论用户名有多少个字符）</p>
     *
     * @param email
     * @return
     *
     * @author gaobaowen
     * @since 2011-9-6 下午05:30:28
     */
    ...
    /**
     * <p>隐藏 MOBILE 手机号码，仅显示手机号码的前 3 位和后 3 位，其余位数使用 * 取代</p>
     *
     * @param mobile
     * @return
     *
     * @author gaobaowen
     * @since 2011-11-30 下午02:43:33
     */
    public static String hideMobile(String mobile) {
    	...
    	chs[3] = chs[4] = chs[5] = chs[6] = chs[7] = '*';
    	return new String(chs);
    }

    /**
     * <p>使用 *** 隐藏会员名。详见 {@link #hideMemberName(String, String)}</p>
     *
     * @param name  原始会员名
     * @return  隐藏之后的会员名
     *
     * @author gaobaowen
     * @since 2011-10-12 13:51:38
     */
    public static String hideMemberName(String name) {
    	return hideMemberName(name, null);
    }

    /**
     * <p>隐藏会员昵称。隐藏时取会员名的第一个和最后一个字符，当中填充指定的字符。</p>
     *
     * @param name		原始会员名
     * @param alternate	填充的字符（值为 null 时默认采用 ***）
     * @return 隐藏后的会员名。如果原始会员名为 null 或者空值时返回原始的字符串
     *
     * @author gaobaowen
     * @since 2011-10-12 13:48:53
     */
    public static String hideMemberName(String name, String alternate) {
    	if (name == null) {
    		return null;
    	}
    	if (StringUtils.isBlank(alternate)) {
    		alternate = "***";
    	} else {
    		alternate = trim(alternate);
    	}
    	char[] alt = alternate.toCharArray();
    	char[] chs = new char[2 + alt.length];
    	chs[0] = name.charAt(0);
    	chs[chs.length - 1] = name.charAt(name.length() - 1);
    	System.arraycopy(alt, 0, chs, 1, alt.length);
    	return new String(chs);
    }

    /**
     * <p>计算字符串占用宽度数，汉字及全角符号计为 2 个宽度</p>
     *
     * @param str  需要计算的字符串
     * @return
     * <pre>
     * 	StringUtil.widthLength(null)   = 0
     *  StringUtil.widthLength("")     = 0
     *  StringUtil.widthLength("a")    = 1
     *  StringUtil.widthLength("中")   = 2
     *  StringUtil.widthLength("我们")  = 4
     *  StringUtil.widthLength("大小a") = 5
     * </pre>
     *
     * @author gaobaowen
     * @since 2011-10-27 13:21:36
     */
    public static int widthLength(String str) {
    	if (str == null) {
    		return 0;
    	}
    ...
    /**
     * <p>判断字符串数组中是否有空白字符或者 null 值。</p>
     *
     * @param strs
     * @return
     *
     * @author gaobaowen
     * @since 2011-11-28 17:18:02
     */
     ...
     *
     * @author gaobaowen
     * @since 2011-11-30 13:07:49
     */
	public static boolean isByteHex(String hexKey) {
    ...
    public static void main(String[] args) {
        System.out.println(hideEmail("frankiegao123@gmail.com"));
        System.out.println(hideMobile("13764399574"));
    }
}
