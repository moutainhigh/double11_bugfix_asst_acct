...
<!--right -->
	<div class="right_850px floatright"><!--右侧开始 -->
      ...
      <div class="box_806 padding_10px ltr_1px_gray bg_white fontgray_0 ">我是买家 > 云营销 ></span> <span class="fontred">供应商管理</span></div>
      ...
      <div class="box_806 lable_bg_style padding_lr_10px ">
        <div id="apply" class="lable_after" style="cursor: pointer"> 申请中的供应商 </div>
            <div id="alignment" class="lable_present" style="cursor: default"> 合作中的供应商 </div>
...
<#if (distributeSupplierDOList)?? && (distributeSupplierDOList?size >0)>
		<#list distributeSupplierDOList as distributeSupplierDO>
          <tr class="bottom_1px_gray_dashed fontgray_03">
            ...
            <td>
	            <#if distributeSupplierDO.cooperateMonth?? && distributeSupplierDO.cooperateMonth == 0>
	            	无限
	            <#else>
...
<#else>
<tr><td colspan="7" align='center'><label class="hong">查不到任何合作中供应商信息！</label></td></tr>
</#if>               
        </table>
<#if (distributeSupplierDOList)?? && (distributeSupplierDOList?size >0)>
