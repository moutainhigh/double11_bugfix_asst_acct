			...
			<p class="exinfo">完成以下操作即可成功开店。</p>
				...
				<li class="item finished">
				  ...
				  <LI class="item finished">
					  ...
					  <UL class=subitem>
					  <LI class=fns>收款账号绑定 
					  <LI class=fns>委托退款服务协议签订 </LI></UL></DIV><SPAN class=icon-fns></SPAN></LI>
				<li class="item">
					...
					<div class="btnrow">
						<#if shopFlowInfoDO?exists && shopFlowInfoDO.isFillComplete==0 && shopFlowInfoDO.auditStatus!=-1 || (shopFlowInfoDO.isFillComplete==1 && shopFlowInfoDO.auditStatus==-100)>
						...
						<#elseif shopFlowInfoDO?exists && shopFlowInfoDO.auditStatus==0 || shopFlowInfoDO.auditStatus==-1>
							<a href="/shop/showAuditStatusPageAction.htm" class="btn-opstatus"><span>查看审核状态</span></a>
						<#else>
