	      ...
	      <div class="ptitle">
			...
			<p class="exinfo">完成以下操作即可成功开店。</p>
				...
				<li class="item finished">
					...
					<#if shopFlowInfoDO?exists && (shopFlowInfoDO.auditStatus == 1) && shopFlowInfoDO.isAccountSet == 1>
						<li class="item">
							...
							<div class="btnrow">
								<a href="/shop/showPayMarginPageAction.htm" class="btn-opstart"><span>开始</span></a>
							</div>
						</li>
					<#elseif shopFlowInfoDO?exists && (shopFlowInfoDO.auditStatus == 2) && shopFlowInfoDO.isAccountSet == 1>
						<li class="item">
							<div class="title"><h2>缴纳保证金</h2></div>					
							<div class="text">
								<p>您还没有缴纳保证金</p>
							...
							<div class="btnrow">
								<a href="/margin/mymargin.htm" class="btn-opstart"><span>开始</span></a>
							</div>
						</li>
					<#else> 
						<li class="item disabled">
							...
							<div class="btnrow">
								<a href="#" class="btn-opstart"><span>开始</span></a>
							</div>
						</li>
					</#if>
